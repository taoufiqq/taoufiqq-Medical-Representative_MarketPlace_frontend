...
useEffect(()=>{
  ...
  axios.get(`https://marketplace-elhanchaoui-api.herokuapp.com/Admin/getAllOrder`)
...
//------------------ validate Order --------------------------
  ...
  const validateOrder = (id) => {
    ...
    axios.put(`https://marketplace-elhanchaoui-api.herokuapp.com/Admin/validateOrder/${id}`)
    .then(res => {
    console.log(res);
...
const deleteOrder = (id)=>{
  ...
  if (msgConfirmation) {   
  axios.delete(`https://marketplace-elhanchaoui-api.herokuapp.com/Admin/deleteOrder/${id}`)
  .then(function (response) {

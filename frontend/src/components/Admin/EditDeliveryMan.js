...
useEffect(()=>{
  ...
  axios.get(`https://marketplace-elhanchaoui-api.herokuapp.com/Admin/getDeliveryById/${id_DeliveryMan}`)
...
axios.put(`https://marketplace-elhanchaoui-api.herokuapp.com/Admin/updateDelivery/${id_DeliveryMan}`,data)
.then(res => {
  if(res.error){
    return false
  }else{

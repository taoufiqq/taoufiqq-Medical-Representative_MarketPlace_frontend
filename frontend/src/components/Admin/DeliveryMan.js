...
const DeliveryMan = () => {
  ...
  // get all DeliveryMan and show it in table
    ...
    useEffect(()=>{
      ...
      axios.get(`https://marketplace-elhanchaoui-api.herokuapp.com/Admin/getAllDelivery`)
  ...
  const deleteDeliveryMan= (id)=>{
    ...
    if (msgConfirmation) {
    axios.delete(`https://marketplace-elhanchaoui-api.herokuapp.com/Admin/deleteDelivery/${id}`)
    .then(function (response) {

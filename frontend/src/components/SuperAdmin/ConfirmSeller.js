...
useEffect(()=>{
  ...
  axios.get(`https://marketplace-elhanchaoui-api.herokuapp.com/superAdmin/getSellerById/${id_seller}`)
...
axios.put(`https://marketplace-elhanchaoui-api.herokuapp.com/superAdmin/updateSeller/${id_seller}`,data)
.then(res => {
  if(res.error){
    return false
  }else{

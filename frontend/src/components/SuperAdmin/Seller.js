...
// get all sellers 
  ...
  useEffect(()=>{
    ...
    axios.get(`https://marketplace-elhanchaoui-api.herokuapp.com/superAdmin/getAllSellers`)
  ...
  const deleteSeller = (id)=>{
    axios.delete(`https://marketplace-elhanchaoui-api.herokuapp.com/superAdmin/deleteSeller/${id}`)
    .then(function (response) {

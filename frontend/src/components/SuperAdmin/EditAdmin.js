...
useEffect(()=>{
    ...
    axios.get(`https://marketplace-elhanchaoui-api.herokuapp.com/superAdmin/getAdminById/${id_admin}`)
...
axios.put(`https://marketplace-elhanchaoui-api.herokuapp.com/superAdmin/updateAdmin/${id_admin}`,data)
  .then(res => {
    if(res.error){
      return false
    }else{

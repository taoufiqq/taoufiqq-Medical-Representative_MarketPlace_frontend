...
// get all admin and show it in table
  ...
  useEffect(()=>{
    ...
    axios.get(`https://marketplace-elhanchaoui-api.herokuapp.com/superAdmin/getAllAdmins`)
  ...
  const deleteAdmin = (id)=>{
    ...
    if (msgConfirmation) {
    axios.delete(`https://marketplace-elhanchaoui-api.herokuapp.com/superAdmin/deleteAdmin/${id}`)
    .then(function (response) {

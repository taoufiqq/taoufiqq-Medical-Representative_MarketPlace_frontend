...
const  ListProducts=()=> {
    ...
    const IdSeller=localStorage.getItem('IdSeller');
      ...
      useEffect(()=>{
        ...
        axios.get(`https://marketplace-elhanchaoui-api.herokuapp.com/Seller/getProductBySellername/${IdSeller}`)
  ...
  const deleteProduct = (id)=>{
    ...
    if (msgConfirmation) {   
    axios.delete(`https://marketplace-elhanchaoui-api.herokuapp.com/Seller/deleteProduct/${id}`)
    .then(function (response) {

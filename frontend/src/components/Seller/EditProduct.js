...
useEffect(()=>{
    ...
    axios.get(`https://marketplace-elhanchaoui-api.herokuapp.com/Seller/getProductById/${idProduct}`)
...
//---------Edit Product------------- 
	...
	axios.put(`https://marketplace-elhanchaoui-api.herokuapp.com/Seller/updateProduct/${idProduct}`,Product)
    .then(res => {
    if(res.error){
      return false
    }else{
